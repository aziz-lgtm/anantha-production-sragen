    ...
    return(
        <section className="fixed top-4 z-100 justify-between self-center">
            <nav className="border rounded-2xl border-white/10 bakcdrop-blur-lg bg-white/10 w-[1373px] h-[100px]">
                <div className="w-[559px] h-[99px] flex flex-row bg-transparent">
                    ...
                    <span className=" font-['Afacad_Flux]  text-white text-center text-[40px] bg-transparent w-[211px] h-[63px] leading-[1.2]top-whitespace-break-spaces">ANANTHA</span>
                    <span className="font-['Afacad_Flux] font-[400px] w-[211px] h-[35px] text-white text-center text-[18px] bg-transparent whitespace-break-spaces leading-[1.2] tracking-[0px] -mt-3">-PRODUCTION-</span>
                    </div>
                    <div>
                        {/* {NAV_ITEMS.map} */}
                    </div>
